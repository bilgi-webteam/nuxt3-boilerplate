...
<h2 class="text-2xl font-bold my-6">Subheader h2</h2>
...
<h3 class="text-xl font-bold my-4">Subheader h3</h3>
...
<h4 class="text-lg font-bold my-2">Subheader h4</h4>
...
<h5 class="text-base font-bold my-1"Subheader h5</h5>
