  ...
  ">
    <header class="absolute inset-x-0 top-0 z-50">
      <div class="max-w-screen-xl mx-auto">
        ...
        <MenuDesktop :menuClass="'relative pt-6 lg:pr-0 flex justify-between lg:justify-start'" :menuContainerClass="'hidden md:pl-0 lg:flex lg:gap-x-3'" :ColorModeClass="'ml-6'" />
